...
class ArtikelController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            'gambar_artikel' => 'required|file|mimes:jpeg,jpg,png,webp|max:1024',
            'judul_artikel' => 'required',
            'subjudul_artikel' => 'required',
            'deskripsi_artikel' => 'required',
        ],[
            'gambar_artikel' => 'Pilih Gambar',
            'gambar_artikel.max' => 'Image Melebihi 1024kb',
    ...
    {
        $this->validate($request,[
            'gambar_artikel' => '|file|mimes:jpeg,jpg,png,webp|max:1024',
            'judul_artikel' => '',
            'subjudul_artikel' => '',
            'deskripsi_artikel' => '',
        ],[
