            ...
            <div class="row">
                <div class="col-5 col-sm-6">
                    <div class="container d-flex  align-items-center gap-3">
                        ...
                        <p class="mb-0 fs-2 fw-bold">Keranjang</p>   
                    </div>
                </div>
                <div class="col-7 col-sm-6 my-auto">
                    <p class="border-0 mb-2">Total Barang : {{ $chart->count() }}</p>
                ...
                <div class="tableHead">
                    <div class="col-md-12">
                        <div class="row fw-bold text-center">
                            <div class="col-md-6 col-3">Produk</div>
                            <div class="col-md-2 col-3">Harga</div>
                            <div class="col-md-2 col-3">Jumlah Barang</div>
                                        ...
                                        <div class="row" id="tr_row">
                                            <div class="col-md-6 col-6">
                                                <div class="row" id="produk">
                                                    ...
                                                    <div class="judul_barang mt-4 col-md-2 col-12">
                                                        <p>{{$item->Barang->judul_barang}}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="harga col-md-2 mt-5 col-3 text-center">
                                            ...
                                            <div class="qty col-md-2 mt-5 col-3 text-center">
                                                <span class="fw-bold">{{($item->qty) }}</span>
                                            </div>
                                            <div class="col-md-2 col-3 mt-5 text-center">
                                                {{-- <a href="{{ route('Favorit-delete',['id' => $item->id]) }}">Hapus</a> --}}
                                                <form method="POST" action="{{ url('chart',$item->id_barang) }}">
                                                    @csrf
                                                    @method('delete')
