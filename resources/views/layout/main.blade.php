...
<html>
  <head>
    <meta charset="utf-8">
  <meta name="description" content="Elegan Fashion Store">
  <meta name="keywords" content="elegan fashion store">
  <meta name="author" content="eleganfashion.com">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="icon" type="image/x-icon" href="{{ asset('img/ELEGAN_PNG.png') }}">
    <title>Elegan Fashion Store</title>
